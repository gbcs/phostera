...
class SettingsData: NSObject, Codable {
    ...
    var currentProjectId:String = "default"
    var defaultContentLoaded:Bool = false
}
...
class SettingsService {
    ...
    private func settingsURL() -> URL {
        return URL.documentsDirectory.appendingPathComponent("settings", conformingTo: .propertyList)
    }
